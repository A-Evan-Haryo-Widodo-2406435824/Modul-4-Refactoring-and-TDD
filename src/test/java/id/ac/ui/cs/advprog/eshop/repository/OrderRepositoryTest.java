...
public class OrderRepositoryTest {
    ...
    void setUp(){
        ...
        Order order1 = new Order("1521fdb0-96e4-4a01-ba9d-4566d6697287",
                products, 1708560000L, "Safira Sudrajat");
        orders.add(order1);

        Order order2 = new Order("1421fdb0-96e4-4a01-ba9d-4566d6697287",
                products, 1708570000L, "Safira Sudrajat");
        orders.add(order2);

        Order order3 = new Order("1321fdb0-96e4-4a01-ba9d-4566d6697287",
